  ...
  return (
    <div className="container-main py-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-heading font-bold text-fixral-night-blue mb-8 text-center">
          Fixral Design System Örnekleri
        </h1>

        {/* Button Examples */}
        <FixralCard className="mb-8">
          <h2 className="text-2xl font-heading font-semibold text-fixral-night-blue mb-6">
            Butonlar
          </h2>
          ...
          <div className="mt-6">
            <h3 className="text-lg font-heading font-medium text-fixral-night-blue mb-4">
              Farklı Boyutlar
            </h3>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <FixralCard variant="default">
            <h3 className="text-lg font-heading font-semibold text-fixral-night-blue mb-3">
              Default Card
            </h3>
        ...
        <FixralCard className="mt-8">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-heading font-bold text-fixral-night-blue">
              H1 Başlık - Orbitron Font
            </h1>
            <h2 className="text-3xl font-heading font-semibold text-fixral-night-blue">
              H2 Başlık - Orbitron Font
            </h2>
            <h3 className="text-2xl font-heading font-medium text-fixral-night-blue">
              H3 Başlık - Orbitron Font
            </h3>
