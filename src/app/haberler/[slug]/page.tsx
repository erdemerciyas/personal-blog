    ...
    try {
        ...
        return {
            ...
            openGraph: {
                ...
                description: translation.metaDescription,
                type: 'article',
                url: `https://fixral.com/haberler/${news.slug}`,
                images: [
                    {
...
export default async function NewsDetailPage({ params }: PageProps) {
    try {
        ...
        const jsonLd = {
            ...
            mainEntityOfPage: {
                '@type': 'WebPage',
                '@id': `https://fixral.com/haberler/${news.slug}`,
            },
        };
                        ...
                        <aside className="lg:col-span-3 space-y-6">
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
                                ...
                                <div className="flex justify-center gap-4">
                                    <a
                                        href={`https://twitter.com/intent/tweet?url=https://fixral.com/haberler/${news.slug}`}
                                        target="_blank"
                                    ...
                                    <a
                                        href={`https://www.facebook.com/sharer/sharer.php?u=https://fixral.com/haberler/${news.slug}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    ...
                                    <a
                                        href={`https://www.linkedin.com/sharing/share-offsite/?url=https://fixral.com/haberler/${news.slug}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
