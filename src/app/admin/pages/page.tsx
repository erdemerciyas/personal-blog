                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        onClick={saveEditing}
                        disabled={saving}
                        className="px-4 py-2 bg-brand-primary-700 text-white rounded-lg hover:bg-brand-primary-800 disabled:opacity-50 transition-colors flex items-center space-x-2"
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              className="p-1 text-slate-400 hover:text-brand-primary-700 transition-colors"
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          disabled={saving}
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${page.isActive ? 'bg-brand-primary-700' : 'bg-slate-200'
                            }`}
                        >
                          <span
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          disabled={saving}
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${page.showInNavigation ? 'bg-brand-primary-700' : 'bg-slate-200'
                            }`}
                        >
                          <span
