  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Proje Düzenle</h1>
                <p className="text-sm text-slate-300">Portfolio projesini güncelle</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 py-8">
        ...
        {/* Page Header */}
        <div className="mb-8">
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2 flex items-center space-x-3">
                  <PencilIcon className="w-8 h-8 text-purple-400" />
                  <span>Proje Düzenle</span>
                </h2>
                <p className="text-slate-300 text-lg">
                  Portfolio projesinin bilgilerini güncelleyin.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                      style={{
                        color: 'white',
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl pl-11 pr-4 py-3 text-white placeholder-slate-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl pl-11 pr-4 py-3 text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                        required
                      />
                    </div>
                  </div>
                    ...
                    {formData.technologies.map((tech, index) => (
                      <div key={index} className="flex items-center space-x-2">
                        <input
                          ...
                          className="flex-1 bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                        />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          className="w-5 h-5 text-teal-500 bg-white/10 border-white/20 rounded focus:ring-teal-500 focus:ring-2"
                        />
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <input
                        ...
                        className="w-20 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg px-3 py-2 text-white text-center focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-end space-x-4 pt-6 border-t border-white/10">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex items-center space-x-2 px-8 py-3 bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                  >
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-slate-300 text-sm">Proje Düzenleme Aktif</span>
            </div>
