  ...
  try {
    ...
    return {
      ...
      openGraph: {
        ...
        description: translation.metaDescription,
        type: 'article',
        url: `https://www.fixral.com/tr/haberler/${news.slug}`,
        images: [
          {
      ...
      alternates: {
        canonical: `https://www.fixral.com/tr/haberler/${news.slug}`,
        languages: {
...
export default async function NewsDetailPage({ params }: PageProps) {
  try {
    ...
    if (news.status !== 'published') {
      logger.warn('News article not published', 'NEWS_DETAIL', { slug: params.slug, status: news.status });
      notFound();
    }
            ...
            <aside className="lg:col-span-3 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
                ...
                <div className="flex justify-center gap-4">
                  <a
                    href={`https://twitter.com/intent/tweet?url=https://www.fixral.com/tr/haberler/${news.slug}`}
                    target="_blank"
                  ...
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=https://www.fixral.com/tr/haberler/${news.slug}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=https://www.fixral.com/tr/haberler/${news.slug}`}
                    target="_blank"
                    rel="noopener noreferrer"
